...
import { isEmptyObj, removeNullish } from 'lib/utils/helpers';
import { dirname, resolve } from 'path';
import { AdaConfig, DebugOptions, ResolvedAdaConfig } from 'src/types';
...
async function loadConfig(configArg?: AdaConfig): Promise<ConfigLoadResult> {
  ...
  const explorer = cosmiconfig(MODULE_NAME, { searchStrategy: 'project' });
